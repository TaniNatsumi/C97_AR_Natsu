...
window.onload = function () {
	...
	function loadAssets() {
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/C97_Natsu/C97_Natsu.model3.json", xhrType);
			loader.add('motion1', "assets/C97_Natsu/motions/C97_Natsu1.motion3.json", xhrType);
			loader.add('motion2', "assets/C97_Natsu/motions/C97_Natsu1.motion3.json", xhrType);
